...
import styles from './AboutMeDesktop.module.scss';
      ...
      <div className={styles.container}>
        ...
        <div className={styles.contentContainer}>
          ...
          <p className={styles.description}>
            ...
            especialista em Neuroarquitetura. Com foco em proporcionar saúde e bem-estar 
            através de projetos residenciais e corporativos, bem como consultorias online 
            e presenciais. Minha missão é criar ambientes que promovam qualidade de vida 
            e conexão com a natureza, permitindo aos meus clientes colecionar momentos 
            e celebrar a vida de forma única.
          </p>
        </div>
